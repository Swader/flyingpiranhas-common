<?php
    ...
    namespace flyingpiranhas\common\parser;

    use flyingpiranhas\common\parser\exceptions\ParserException;
        ...
        protected function invalidCharactersCheck(&$sString)
        {
            ...
            foreach ($aInvalidCharacters as $sInvalidCharacter) {
                if (strpos($sString, $sInvalidCharacter) !== false) {
                    $e = new \INTECH\ParserException('Invalid characters detected in the content! :: "' . $sInvalidCharacter . '"');
