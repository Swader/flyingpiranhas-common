<?php
    ...
    use flyingpiranhas\common\session\interfaces\SessionHandlerInterface;
    ...
    class Session implements SessionInterface
    {
        ...
        {
            return (
                ((self::$bSessionStarted && session_destroy()) || !self::$bSessionStarted)
                    ||
                    (!$bDestroyCookie || ($bDestroyCookie && $this->expireCookie()))
            );
        }
        ...
        public function expireCookie()
        {
            if (isset($_COOKIE[session_name()])) {
                ...
                return setcookie(
                    ...
                    $cookieParams['path'], $cookieParams['domain'], $cookieParams['secure']
                );
            }
            return true;
        }
        ...
        {
            throw new SessionException('Can not clone session');
        }
